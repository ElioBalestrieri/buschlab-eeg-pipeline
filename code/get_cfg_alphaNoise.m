function cfg = get_cfg_alphaNoise
...
%% Directories
cfg.dir.main     = fullfile(rootdir, 'alphaNoise/');
cfg.dir.raw      = fullfile(cfg.dir.main, 'Preprocessing', 'rawdata/');
...
cfg.dir.eye      = fullfile(cfg.dir.main, 'Preprocessing', 'preprocessed', 'EYE/');
cfg.dir.eeg      = fullfile(cfg.dir.main, 'Preprocessing', 'preprocessed', 'EEG/');
cfg.dir.tf       = fullfile(cfg.dir.main, 'Preprocessing', 'preprocessed', 'TF/');cfg.dir.grand    = fullfile(cfg.dir.main, 'data', 'GRAND/');


%% Information about channel structure.
cfg.chans.EEGchans = 1:65;
% cfg.chans.data_chans = cfg.EEGchans; % redundant, but some electrpipe functions expect a field with this name.
cfg.chans.VEOGchan = 66;
cfg.chans.HEOGchan = 67;
...
cfg.prep.reref_chan = 1:64; % 48=channel CZ. 31=Pz. []=average ref.
...
cfg.prep.hp_filter_limit = 0.8;% CFG.hp_filter_limit = 0.1; 
...
%% Triggers and epochs
cfg.epoch.tlims = [-1.7 1.5];
cfg.epoch.image_onset_triggers = [];
cfg.epoch.trig_target = 1:3;% CFG.trig_target = []; %e.g., [21:29, 200:205]
...
% and interpolated.
cfg.eyetrack.eye_startEnd = [];% CFG.eye_startEnd       = []; % e.g., [10,20]
...
cfg.ica.ica_overweight_sp = false;% CFG.ica_overweight_sp = 1;
...
% ------------------------------------------
cfg.final.rejthresh_post_ica = 100;
cfg.final.do_channel_interp = true;
cfg.final.channel_interp_zthresh = 3;
